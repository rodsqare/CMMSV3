-- Seed Data for Medical Equipment Management System
...
('Admin Usuario', 'admin@hospital.com', '$2a$10$hashedpassword1', 'administrador', 'Administración', 'activo', 
  '{"gestionEquipos": true, "gestionUsuarios": true, "ordenesTrabajoCrear": true, "ordenesTrabajoAsignar": true, "ordenesTrabajoEjecutar": true, "mantenimientoPreventivo": true, "reportesGenerar": true, "reportesVer": true, "logsAcceso": true, "configuracionSistema": true}'::jsonb),
('María Supervisor', 'supervisor@hospital.com', '$2a$10$hashedpassword2', 'supervisor', 'Supervisión Técnica', 'activo',
  '{"gestionEquipos": true, "gestionUsuarios": false, "ordenesTrabajoCrear": true, "ordenesTrabajoAsignar": true, "ordenesTrabajoEjecutar": true, "mantenimientoPreventivo": true, "reportesGenerar": true, "reportesVer": true, "logsAcceso": false, "configuracionSistema": false}'::jsonb),
('Juan Pérez', 'tecnico@hospital.com', '$2a$10$hashedpassword3', 'tecnico', 'Biomédico', 'activo',
  '{"gestionEquipos": false, "gestionUsuarios": false, "ordenesTrabajoCrear": false, "ordenesTrabajoAsignar": false, "ordenesTrabajoEjecutar": true, "mantenimientoPreventivo": true, "reportesGenerar": false, "reportesVer": true, "logsAcceso": false, "configuracionSistema": false}'::jsonb),
